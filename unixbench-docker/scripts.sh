...
# === CONFIGURATION ===
IMAGE_NAME="mon-image-unixbench"
RUNTIMES=("crio" "docker" "podman")  # Adapter CRI-O si besoin
ITERATIONS=10
...
{
  "metadata": {
    "name": "unixbench-container"
  },
  "image": {
    "image": "localhost:5000/mon-image-unixbench"
  },
  "log_path": "unixbench-container.log"
}
EOF
